...
| `docs/governance/GOVERNANCE_EFFICIENCY_REFOUNDATION_PHASE_CONTRACT.md` | Active material phase contract for governance-efficiency shadow implementation; Unit 1 is closed, Unit 2 is externally accepted at `f7106977f4613de1830bef46002dbf0a4b8b3cbe`, and Unit 3 governance-gate hardening is complete and awaiting direct supervisor review; structured sources remain non-canonical, current canonical owners are unchanged, and Unit 4/documentary-authority cutover are not authorized. |
...
| `scripts/governance/validate-g28-ledger-shadow.mjs` | Unit 3 schema, lossless partition, compatibility, reference-survival, old/new-buffer append-stability, immutable-commit, and catalog validator. |
| `tests/governance-g28-ledger-shadow.test.mjs` | Unit 3 positive, schema-negative, boundary-negative, deterministic, generated-classification, and immutable-read tests. |
