...
export function validateCanonicalReconciliation(root, state, manifest, equivalence) {
  ...
  for (const text of ['GOVERNANCE-EFFICIENCY-REFOUNDATION', 'GOVERNANCE-EFFICIENCY-REFOUNDATION-SHADOW-STATE-HARDENING-R2']) if (!handoffText.includes(text)) errors.push(`AGENT_HANDOFF missing current action text: ${text}`);
