...
export function validateCanonicalReconciliation(root, state, manifest, equivalence) {
  ...
  for (const text of ['GOVERNANCE-EFFICIENCY-REFOUNDATION', 'GOVERNANCE-EFFICIENCY-REFOUNDATION-UNIT-4-CONTRACT-COMMIT-BINDING-AND-CANDIDATE-PATH-CORRECTION-R2']) if (!handoffText.includes(text)) errors.push(`AGENT_HANDOFF missing current action text: ${text}`);
