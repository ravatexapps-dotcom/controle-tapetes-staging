...
NEXT_AUTHORIZABLE_ACTION: DIRECT SUPERVISOR REVIEW OF GOVERNANCE-EFFICIENCY-REFOUNDATION-CATALOG-TRACEABILITY-VALIDATOR-SHADOW-HARDENING-R2
...
- **`GOVERNANCE-EFFICIENCY-REFOUNDATION` (current — shadow implementation):**
  ...
  state authority and `AGENT_HANDOFF.md` remains the derived handoff. Unit 1 is
  ...
  its catalog, reference validator, Phase-C structured traceability, and generated
  views remain non-canonical. The next gate is `DIRECT SUPERVISOR REVIEW OF
  GOVERNANCE-EFFICIENCY-REFOUNDATION-CATALOG-TRACEABILITY-VALIDATOR-SHADOW-HARDENING-R2`. Documentary-authority
  ...
  `fix: bind governance traceability and reference debts`.
